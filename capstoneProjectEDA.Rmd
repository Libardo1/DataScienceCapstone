...
- Form a collection of documents (i.e. `Corpus`) from text file lines
    ...
    - Detect and remove non-english language text
        - [Segment text language using textcat R package](http://stackoverflow.com/questions/24099098/language-detection-in-r-with-the-textcat-package-how-to-restrict-to-a-few-lang)  
...
- Word feature analysis  
    ...
    - Top 20 (i.e. highest frequency of occurence) words 
...
- Word feature analysis (cont.)  
    ...
    - [Term Frequency visualization](http://beyondvalence.blogspot.com/2014/01/text-mining-4-performing-term.html)  
       - [Term Document Matrix](http://beyondvalence.blogspot.com/2014/01/text-mining-3-stemming-text-and.html)  
    - [Rweka R package syntax for computing bigram Term Document Matrix](http://stackoverflow.com/questions/17703553/bigrams-instead-of-single-words-in-termdocument-matrix-using-r-and-rweka)  
    - [Rweka R package syntax for computing trigram Term Document Matrix](http://stackoverflow.com/questions/19615181/finding-ngrams-in-r-and-comparing-ngrams-across-corpora)  
