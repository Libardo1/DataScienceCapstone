...
qplot(names(termFreqsTopTwenty),
      ...
      stat="identity",
      xlab="Terms",
      ylab="P(term) [%]") + coord_flip() + theme_gray(base_size=14) +
...
`r percentageToSample`% sample of the english language text files  
    - Unexpected result suggests that bigrams that include the word `zombie` 
    occur with a relatively low frequency  
...
`r percentageToSample`% sample of the english language text files  
    - Unexpected result suggests that trigrams that include the word `zombie` 
    occur with a relatively low frequency
